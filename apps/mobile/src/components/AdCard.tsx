...
const styles=StyleSheet.create({card:{backgroundColor:'#FFF',borderRadius:15,overflow:'hidden',borderWidth:1,borderColor:'#E1E8E4',flex:1,shadowColor:'#16382F',shadowOpacity:.04,shadowRadius:7,shadowOffset:{width:0,height:2},elevation:1},imageWrap:{height:150,position:'relative',backgroundColor:'#EEF2F0'},image:{width:'100%',height:'100%',backgroundColor:'#EEF2F0'},noImage:{alignItems:'center',justifyContent:'center'},noImageText:{fontWeight:'900',color:GREEN,fontSize:11},watermark:{position:'absolute',left:7,right:7,top:'50%',fontSize:8,fontWeight:'900',letterSpacing:1,color:'#FFF',textAlign:'center',opacity:.18,transform:[{rotate:'-16deg'}],textShadowColor:'#000',textShadowOffset:{width:0,height:1},textShadowRadius:2},save:{position:'absolute',right:8,top:8,width:34,height:34,borderRadius:17,backgroundColor:'#FFFE',alignItems:'center',justifyContent:'center'},body:{padding:10},title:{fontWeight:'800',fontSize:14,color:'#17202A',minHeight:36,lineHeight:18},price:{color:GREEN,fontWeight:'900',fontSize:15,marginTop:6},meta:{fontSize:11,color:'#74808B',marginTop:5}});
