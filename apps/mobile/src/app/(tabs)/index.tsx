...
function money(value: number) { return `UGX ${Number(value).toLocaleString()}`; }
  ...
  return (
    <View style={styles.screen}>
      <FlatList
        ...
        ListHeaderComponent={<>
          <View style={styles.top}><Image source={require('../../../assets/images/minify-market.png')} style={styles.logo} /><Pressable onPress={() => router.push('/account')}><Text style={styles.account}>Account</Text></Pressable></View>
