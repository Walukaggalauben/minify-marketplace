...
const items: Item[] = [
  ...
  { label: 'Pro Sales', icon: 'trending-up-outline', path: '/info?section=pro-sales' },
  { label: 'Premium service', icon: 'diamond-outline', path: '/info?section=premium' },
  { label: 'My balance', icon: 'wallet-outline', path: '/info?section=balance' },
  { label: 'Request help', icon: 'person-outline', path: '/info?section=help' },
  { label: 'FAQ', icon: 'help-circle-outline', path: '/info?section=help' },
